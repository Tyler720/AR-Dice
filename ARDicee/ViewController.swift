...
//  ARDicee
//
//  Created by Tyler Cantlon on 11/14/18.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    //has detected horizontal surface and given it a width and a hight
    ...
    func createPlane(withPlaneAnchor planeAnchor: ARPlaneAnchor) -> SCNNode {
        ...
        //convert the vertical plane into a flat plane. 1pie rad = 180 deg
